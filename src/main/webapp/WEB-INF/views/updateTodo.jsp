...
<%
    ...
    Integer objCurrentTodoNumber = (Integer)request.getAttribute("number");
    int currentTodoNumber = objCurrentTodoNumber;
...
<table border="1" cellspacing="0" cellspacing="0" width="960" align="right">
    ...
    <tr>
        <% if (currentTodoNumber != todoList.get(i).getNumber()) { %>
        <td width="480">
        ...
        <td>
            <form action="../../todo/<%= todoList.get(i).getNumber() %>" method="post" style="display: inline">
                ...
                <textarea name="revisedContent" rows="1" cols="50"><%= todoList.get(i).getContent() %></textarea>
