...
<center>
    ...
    <table border="1" cellpadding="0" cellspacing="0" width="869">
        ...
        <tr>
            ...
            <td width="92">
                ...
                <form action="../<%= session.getAttribute("currentBoardNumber") %>/comment/view-update/<%= commentList.get(i).getNumber() %>/" method="get" style="display: inline">
                    <input type="hidden" name="pageNumber" value="<%= pageNumber %>">
                    <input type="submit" value="수정">
                </form>
                <form action="../<%= session.getAttribute("currentBoardNumber") %>/comment/<%= commentList.get(i).getNumber() %>" method="post" style="display: inline">
                    <input type="hidden" name="pageNumber" value="<%= pageNumber %>">
    ...
    <br>
    <form action="../<%= session.getAttribute("currentBoardNumber") %>/comment" method="post">
        <input type="hidden" name="pageNumber" value="<%= pageNumber %>">
        <table border="1" cellspacing="0" cellspacing="0" width="869">
        <tr>
            <td>
